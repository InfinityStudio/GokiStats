...
public class GuiStatButton extends GuiButton
{
  ...
  public void drawButton(Minecraft mc, int mouseX, int mouseY)
  {
    if (this.visible)
    {
      ...
      GL11.glPushMatrix();
      GL11.glTranslatef(this.xPosition, this.yPosition, 0.0F);
      drawCenteredString(fontrenderer, message, (int)(this.width / 2 * GuiStats.SCALE), (int)(this.height * GuiStats.SCALE) + 2, messageColor);
      GL11.glPopMatrix();
    }
  }
  ...
  {
    return (this.enabled) && (this.visible) && (mouseX >= this.xPosition) && (mouseY >= this.yPosition) && (mouseX < this.xPosition + this.width * GuiStats.SCALE) && (mouseY < this.yPosition + this.height * GuiStats.SCALE);
  }
