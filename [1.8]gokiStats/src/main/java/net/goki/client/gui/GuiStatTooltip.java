...
public class GuiStatTooltip extends Gui
{
  ...
  public void draw(int drawX, int drawY, int mouseButton)
  {
    ...
    int width = Math.max(this.mc.fontRendererObj.getStringWidth(message), this.mc.fontRendererObj.getStringWidth(header)) + this.padding * 2;
    ...
    drawString(this.mc.fontRendererObj, header, x + this.padding / 2, y - h * 3 + this.padding / 2, -13312);
    drawString(this.mc.fontRendererObj, message, x + this.padding / 2, y - h * 2 + this.padding / 2, -1);
    drawString(this.mc.fontRendererObj, cost, x + this.padding / 2, y - h + this.padding / 2, -16724737);
