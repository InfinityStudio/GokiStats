...
public class StatTreasureFinder extends Stat
{
  ...
  public static String[] defaultEntries = { new TreasureFinderEntry(Blocks.sand, 0, Items.gold_nugget, 0, 1, 10).toConfigurationString(), new TreasureFinderEntry(Blocks.dirt, 0, Items.rotten_flesh, 0, 1, 40).toConfigurationString(), new TreasureFinderEntry(Blocks.dirt, 0, Items.bone, 0, 1, 20).toConfigurationString(), new TreasureFinderEntry(Blocks.dirt, 0, Items.spider_eye, 0, 1, 10).toConfigurationString(), new TreasureFinderEntry(Blocks.dirt, 0, Items.gunpowder, 0, 1, 10).toConfigurationString(), new TreasureFinderEntry(Blocks.dirt, 0, Items.slime_ball, 0, 1, 10).toConfigurationString(), new TreasureFinderEntry(Blocks.sand, 0, Items.glass_bottle, 0, 1, 10).toConfigurationString(), new TreasureFinderEntry(Blocks.sand, 0, Items.clock, 0, 1, 5).toConfigurationString(), new TreasureFinderEntry(Blocks.sand, 0, Items.compass, 0, 1, 5).toConfigurationString(), new TreasureFinderEntry(Blocks.sand, 0, Items.clay_ball, 0, 1, 20).toConfigurationString(), new TreasureFinderEntry(Blocks.dirt, 0, Items.bowl, 0, 1, 6).toConfigurationString(), new TreasureFinderEntry(Blocks.dirt, 0, Items.potato, 0, 1, 10).toConfigurationString(), new TreasureFinderEntry(Blocks.dirt, 0, Items.carrot, 0, 1, 10).toConfigurationString(), new TreasureFinderEntry(Blocks.dirt, 0, Items.apple, 0, 1, 10).toConfigurationString(), new TreasureFinderEntry(Blocks.leaves, 0, Items.apple, 0, 1, 10).toConfigurationString(), new TreasureFinderEntry(Blocks.leaves2, 0, Items.apple, 0, 1, 10).toConfigurationString(), new TreasureFinderEntry(Blocks.dirt, 0, Item.getItemFromBlock(Blocks.red_mushroom), 0, 1, 10).toConfigurationString(), new TreasureFinderEntry(Blocks.dirt, 0, Item.getItemFromBlock(Blocks.brown_mushroom), 0, 1, 10).toConfigurationString(), new TreasureFinderEntry(Blocks.dirt, 0, Item.getItemFromBlock(Blocks.red_flower), 0, 1, 10).toConfigurationString(), new TreasureFinderEntry(Blocks.dirt, 0, Item.getItemFromBlock(Blocks.yellow_flower), 0, 1, 10).toConfigurationString(), new TreasureFinderEntry(Blocks.dirt, 0, Items.stick, 0, 1, 100).toConfigurationString(), new TreasureFinderEntry(Blocks.tallgrass, 0, Items.pumpkin_seeds, 0, 1, 30).toConfigurationString(), new TreasureFinderEntry(Blocks.tallgrass, 0, Items.melon_seeds, 0, 1, 30).toConfigurationString(), new TreasureFinderEntry(Blocks.dirt, 0, Items.beef, 0, 2, 50).toConfigurationString(), new TreasureFinderEntry(Blocks.dirt, 0, Items.porkchop, 0, 2, 50).toConfigurationString(), new TreasureFinderEntry(Blocks.dirt, 0, Items.chicken, 0, 2, 50).toConfigurationString(), new TreasureFinderEntry(Blocks.sand, 0, Items.iron_ingot, 0, 2, 10).toConfigurationString(), new TreasureFinderEntry(Blocks.sand, 0, Items.gold_ingot, 0, 2, 10).toConfigurationString(), new TreasureFinderEntry(Blocks.dirt, 0, Items.leather, 0, 2, 10).toConfigurationString(), new TreasureFinderEntry(Blocks.dirt, 0, Items.feather, 0, 2, 10).toConfigurationString(), new TreasureFinderEntry(Blocks.dirt, 0, Item.getItemFromBlock(Blocks.wool), 0, 2, 10).toConfigurationString(), new TreasureFinderEntry(Blocks.sand, 0, Items.redstone, 0, 2, 50).toConfigurationString(), new TreasureFinderEntry(Blocks.dirt, 0, Items.bucket, 0, 3, 20).toConfigurationString(), new TreasureFinderEntry(Blocks.dirt, 0, Items.record_11, 0, 3, 2).toConfigurationString(), new TreasureFinderEntry(Blocks.dirt, 0, Items.record_13, 0, 3, 2).toConfigurationString(), new TreasureFinderEntry(Blocks.dirt, 0, Items.record_blocks, 0, 3, 2).toConfigurationString(), new TreasureFinderEntry(Blocks.dirt, 0, Items.record_cat, 0, 3, 2).toConfigurationString(), new TreasureFinderEntry(Blocks.dirt, 0, Items.record_chirp, 0, 3, 2).toConfigurationString(), new TreasureFinderEntry(Blocks.dirt, 0, Items.record_far, 0, 3, 2).toConfigurationString(), new TreasureFinderEntry(Blocks.dirt, 0, Items.record_mall, 0, 3, 2).toConfigurationString(), new TreasureFinderEntry(Blocks.dirt, 0, Items.record_mellohi, 0, 3, 2).toConfigurationString(), new TreasureFinderEntry(Blocks.dirt, 0, Items.record_stal, 0, 3, 2).toConfigurationString(), new TreasureFinderEntry(Blocks.dirt, 0, Items.record_strad, 0, 3, 2).toConfigurationString(), new TreasureFinderEntry(Blocks.dirt, 0, Items.record_wait, 0, 3, 2).toConfigurationString(), new TreasureFinderEntry(Blocks.dirt, 0, Items.record_ward, 0, 3, 2).toConfigurationString() };
